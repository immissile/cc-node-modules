exports.init = function(grunt) {
  ...
  exports.jsParser = function(fileObj, options) {
    ...
    if (!meta) {
      grunt.log.warn('found non cmd module:\n"' + fileObj.src + '"\n');
      // do nothing
      return;
    }

    if (meta.id) {
      grunt.log.warn('found id in:\n"' + fileObj.src + '"\n');
    ...
    grunt.log.writeln('Creating debug file:\n' + dest + '\n');
  ...
  function moduleDependencies(id, options) {
    ...
    options.paths.some(function(base) {
      ...
      if (grunt.file.exists(filepath)) {
        grunt.log.verbose.writeln('find module:\n"' + filepath + '"\n');
        fpath = filepath;
        return true;
      }
    });
    if (!fpath) {
      grunt.log.warn("can't find module:\n" + alias + '\n');
      return [];
    }
    if (!grunt.file.exists(fpath)) {
      grunt.log.warn("can't find:\n" + fpath + '\n');
      return [];
    }
